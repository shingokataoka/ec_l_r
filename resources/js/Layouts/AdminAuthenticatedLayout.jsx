                            ...
                            <div className="ml-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route('admin.logout')} method="post" as="button" onClick={submitLogout}>
                                            Log Out
                                        </Dropdown.Link>
                                    </Dropdown.Content>
                                </Dropdown>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink method="post" href={route('admin.logout')} as="button" onClick={submitLogout}>
                                Log Out
                            </ResponsiveNavLink>
                        </div>
                    </div>
